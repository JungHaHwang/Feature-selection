...
class CNN2DModel(nn.Module):
    def __init__(self):
        ...
        # 2D Convolutional Layers: input channels=1 (grayscale), output channels=16, kernel size=3
        ...
        # must be changed to fit cropped dataset    
...
train_data_path = "./dataset_baseline/train_cropped_[0, 2, 3, 3]_data.npy"
train_label_path = "./dataset_baseline/train_cropped_[0, 2, 3, 3]_labels.npy"
val_data_path = "./dataset_baseline/test_cropped_[0, 2, 3, 3]_data.npy"
val_label_path = "./dataset_baseline/test_cropped_[0, 2, 3, 3]_labels.npy"
...
for repeat in range(50):
    ...
    for epoch in range(num_epochs):
        ...
        if train_acc == 100.0 and val_acc == 100.0:
            with open("./Result_Training_cropped_[0, 2, 3, 3].txt", "a", encoding="utf-8") as f:
                f.write(f'times {repeat}, TL: {train_loss:.4f}, VL: {val_loss:.4f}, TA: {train_acc:.2f}, VA: {val_acc:.2f}\n')
            del model
