...
folder_A = "./dataset_baseline/train/full_cropped_[0, 2, 3, 3]"
folder_B = "./dataset_baseline/train/empty_cropped_[0, 2, 3, 3]"
folder_C = "./dataset_baseline/test/full_cropped_[0, 2, 3, 3]"
folder_D = "./dataset_baseline/test/empty_cropped_[0, 2, 3, 3]"
...
# Save to .npy files
np.save("./dataset_baseline/train_cropped_[0, 2, 3, 3]_data.npy", images_train)
np.save("./dataset_baseline/train_cropped_[0, 2, 3, 3]_labels.npy", labels_train)
np.save("./dataset_baseline/test_cropped_[0, 2, 3, 3]_data.npy", images_test)
np.save("./dataset_baseline/test_cropped_[0, 2, 3, 3]_labels.npy", labels_test)

print("cropped dataset prepared successfully.")
